...
data M and (2) allows insertions and access in logarithmic time.
"""
import random
import graph
...
class Node(object):
    ...
    Attributes:
        M (int): The maximum number of keys each node can hold.
    """
    def __init__(self, M):
